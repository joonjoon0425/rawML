        ...
        \subsubsection{Upsampling}
            ...
            \begin{enumerate}
                ...
                \item \textbf{Transposed Convolution}. Using stride 2 kernel decrease the size to half. Transposed convolution does this in kind of opposite way, doubling the size.
                    The reason that this is called transposed convolution is that it is same as transposing the matrix representation of convolution operation and applying it to the data.
                    Different kernel can be used in convolution and transposed convolution.
            \end{enumerate}

            \begin{rem}{Transposed Convolution}{TransConv}
                Transposed convolution can be implemented via dilation. The point is that the dilation is applied to the input data, not the kernel.
